...
import com.gouuse.goengine.http.request.DeleteRequest;
import com.gouuse.goengine.http.request.DownloadRequest;
import com.gouuse.goengine.http.request.GetRequest;
import com.gouuse.goengine.http.request.HeadRequest;
import com.gouuse.goengine.http.request.OptionsRequest;
import com.gouuse.goengine.http.request.PatchRequest;
import com.gouuse.goengine.http.request.PostRequest;
import com.gouuse.goengine.http.request.PutRequest;
import com.gouuse.goengine.http.request.RetrofitRequest;
import com.gouuse.goengine.http.request.UploadRequest;
...
public class GoHttp {
     ...
     * @return
     */
    public static UploadRequest UPLOAD(String suffixUrl, UploadCallback uCallback) {
