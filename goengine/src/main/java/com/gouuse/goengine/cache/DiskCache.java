...
import com.gouuse.goengine.utils.system.AppUtil;
...
public class DiskCache implements ICache {
    ...
    private long cacheTime = GoConfig.CACHE_NEVER_EXPIRE;

    public DiskCache(Context context) {
        this(context, getDiskCacheDir(context, GoConfig.CACHE_DISK_DIR),
                calculateDiskCacheSize(getDiskCacheDir(context, GoConfig.CACHE_DISK_DIR)));
    }
            ...
            if (snapshot != null) {
                ...
                if (!TextUtils.isEmpty(content)) {
                    ...
                    if ((createTime + expireMills > Calendar.getInstance().getTimeInMillis())
                            || expireMills == GoConfig.CACHE_NEVER_EXPIRE) {
