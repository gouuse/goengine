...
public class GlideLoader implements ILoader {
    ...
    @Override
    public void load(ImageView target, String url, Options options) {
        load(getRequestManager(target.getContext()).load(url), target, options);
    }

    @Override
    public void load(ImageView target, int resId, Options options) {
    ...
    @Override
    public void load(ImageView target, File file, Options options) {
